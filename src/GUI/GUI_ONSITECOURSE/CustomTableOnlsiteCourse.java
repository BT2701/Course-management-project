...
public class CustomTableOnlsiteCourse extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        String []titleTableCenter= {"ID","Mã khoa","Thời gian","Số tín chỉ"};
        String []titleTableLeft= {"Tên môn học","Thứ","Địa điểm"};
        JLabel lb = (JLabel) c;
        lb.setBorder(new MatteBorder(0, 0, 1, 0, Color.decode("#EEEEEE")));
        if (column == table.getColumnModel().getColumnIndex("Thời gian")) {
